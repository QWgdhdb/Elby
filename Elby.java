public class Elby {
    ...
    public String getResponse(String statement) {
        ...
        int posOfYouAfterI  = findKeyword(statement, "you",  posOfI + 1);
        ...
        else if (statement.equals("The weather is nice.")) {
        ...
        else if (findKeyword(statement, "David", 0) >= 0) {
            response = "He is a good student.";
        }
        else if (findKeyword(statement, "tree", 0) >= 0) {
            response = "That tree is so tall.";
        }
        else if (findKeyword(statement, "candy", 0) >= 0) {
            response = "I like candy.";
        }
        else if (findKeyword(statement, "rain", 0) >= 0) {
            response = "Rain, rain, go away.";
        }
        else if (posOfYou >= 0 && posOfYou < posOfMe) {
        ...
        else if (posOfI >= 0 && posOfI < posOfYouAfterI) {
